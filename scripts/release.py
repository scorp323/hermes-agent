...
AUTHOR_MAP = {
    "morpheusqilee@Morpheuss-MBP.localdomain": "scorp323",  # PR #1 attribution fix
    "morpheusqilee@Morpheuss-MacBook-Pro.local": "scorp323",  # PR #1 attribution fix
    "morpheusqilee@gmail.com": "scorp323",  # PR #1 attribution fix
    "neo@Mac.localdomain": "scorp323",  # PR #1 attribution fix
    "neo@Neos-MBP.localdomain": "scorp323",  # PR #1 Phase 2 config parity hardening
    "neo@Neos-MacBook-Pro.local": "scorp323",  # PR #1 attribution fix
